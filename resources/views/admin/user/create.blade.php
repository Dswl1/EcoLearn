@extends('app')
@section('title')
    {{ __('app.create_user') }} | {{ __('app.app_name') }}
@endsection
...
@section('content')
    <section class="mb-6">
        <nav class="flex gap-2 text-label-sm font-label-sm text-on-surface-variant mb-2">
            ...
            <span>/</span>
            <span class="text-primary-fixed">{{ __('app.create_user') }}</span>
        </nav>
        <h3 class="font-headline-md text-headline-md text-primary-container">{{ __('app.create_user') }}</h3>
    </section>
